...
const englishMessages = {
  ...
  'commands.fill.options.provider': 'LLM provider (openrouter or google)',
  ...
  'commands.plan.options.provider': 'LLM provider (openrouter or google)',
  ...
  'prompts.fill.provider': 'LLM provider',
  ...
  'errors.fill.invalidProvider': 'Invalid provider "{value}". Expected one of: {allowed}.',
...
const portugueseMessages: TranslationDictionary = {
  ...
  'commands.fill.options.provider': 'Provedor de LLM (openrouter ou google)',
  ...
  'commands.plan.options.provider': 'Provedor de LLM (openrouter ou google)',
  ...
  'prompts.fill.provider': 'Provedor de LLM',
  ...
  'errors.fill.invalidProvider': 'Provedor "{value}" inválido. Use um dos seguintes: {allowed}.',
